...
export const solutionsData = [
    ...
    },
    {
      ...
      description: 'Os resultados de redução de custos tornam-se exponenciais quando as alavancas de valor são aplicadas de forma estratégica e combinada, com engajamento multifuncional e sponsorship da alta gestão, garantindo a captura efetiva das oportunidades.\n\nO Spend Assessment & Strategic Sourcing da Arco identifica e executa iniciativas estruturadas para transformar gasto em valor capturado, da análise ao fechamento, com governança e resultados sustentáveis.',
      imageNumber: 2,
    ...
    },
    {
      ...
      description: 'A Arco otimiza processos críticos, eleva a maturidade organizacional e acelera resultados. Apoia a adoção de melhores práticas globais em compras e supply chain, gerando eficiência, transparência e impacto estratégico mensurável. Implementa soluções digitais que transformam a função de procurement, integrando marketplaces, inteligência artificial e benchmarks proprietários.',
      imageNumber: 3,
